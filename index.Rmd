...
<img src="./logo.png" width="150px" align="right" display="block" style="margin-top: 1em;">

<h1 style="margin-top: 1em;">
Multivariate Covariance Generalized Linear Models for the Analysis of Experimental Data
</h1>

<div style="height: 8ex; margin: 2em 5em 1em 0em;">
...
**Key-words**: multivariate response, generalized estimating
equations, Poisson-Tweedie, count data.

***

## Information

  * Short-course at: [62nd RBras and 17th SEAGRO meeting](http://www.rbras.org.br/rbras62/)
  * Date: July 24th -- 28th, 2017
  * Local: Lavras-MG, Brazil
  * Workload: 4 hours

<!------------------------------------------- -->
[Wagner H. Bonat]: http://leg.ufpr.br/doku.php/pessoais:wbonat
[Walmes M. Zeviani]: http://leg.ufpr.br/~walmes/
